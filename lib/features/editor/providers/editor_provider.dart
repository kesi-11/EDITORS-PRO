...
/// Curated subset of the 11 new pro widgets — the rest are exposed via
/// the Inspector panel (right side) rather than as left-panel tabs to
/// avoid UI overload. See docs/PRO_TOOLS.md.
enum LeftPanelTab {
  media,
  effects,
  text,
  ...
  speed,
  keyframes,
  // ─── Phase F.2: Pro tools tabs ────────────────────────────────────
  mixer,        // per-track volume/pan/mute/solo — AudioMixerPanel
  scopes,       // waveform / vectorscope / RGB parade / histogram
  markers,      // timeline markers — MarkersPanel
  luts,         // LUT browser — LutBrowser
  eq,           // 8-band parametric EQ — EqPanel
}
